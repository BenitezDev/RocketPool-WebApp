...
GameScene.prototype.draw = function () {
  ...
  this.scores.forEach(score => score.draw());
...
GameScene.prototype.instantiateBallsInCircle = function () {
  ...
  let imgBallPool = [
    sprites.ball_5, sprites.ball_4,
    sprites.ball_3, sprites.ball_2,
    sprites.ball_1, sprites.ball_8,
    sprites.ball_7, sprites.ball_6
  ];
